...
<div class="xs-pd-20-10 pd-ltr-20">
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
            <div class="card-box height-100-p widget-style3">
                <div class="d-flex flex-wrap">
                    ...
                    <div class="widget-icon">
                        <div class="icon" style="padding-left: 5px" data-color="#ff5b5b" style="color: rgb(255, 91, 91);">
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
            <div class="card-box height-100-p widget-style3">
                <div class="d-flex flex-wrap">
                    ...
                    <div class="widget-icon">
                        <div class="icon" style="padding: 5px auto;padding-right: 5px;padding-left: 5px;" >
    ...
    <div class="card-box pb-10">
        <div class="h5 pd-20 mb-0">  محصولات در انتظار تایید </div>
