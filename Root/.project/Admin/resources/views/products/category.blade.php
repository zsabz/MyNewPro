        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr class="table table-striped">
                    ...
                    <td>{{$item -> title}}</td>
                    <td><a href="addCategory/{{$item->id}}/edit" class="btn btn-primary btn-sm">ویرایش</a></td>
                    <td>
                    ...
                    <td><button onclick="ajax_change_statue(event,{{$item->id}}, {{$item->status}}, 'Category')"
                       ...
                       @endif
                        ...
                        <th scope="row">--{{ $loop->iteration }}</th>
                        <td>{{$subitem -> title}}</td>
                        <td><a href="addCategory/{{$subitem->id}}/edit" class="btn btn-primary btn-sm">ویرایش</a></td>
                        <td>
                    ...
                    <td><button onclick="ajax_change_statue(event,{{$subitem->id}}, {{$subitem->status}}, 'Category')"
                        class="btn btn-success btn-sm">
