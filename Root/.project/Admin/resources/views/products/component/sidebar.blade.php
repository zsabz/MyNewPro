...
<div class="left-side-bar">
    <div class="brand-logo">
        <a class="justify-content-center" href="index.html">
            ...
            <!-- صفحه ی نخست -->
            <img src="/img/icons/NEW-LOGO.png">
        </a>
    ...
    <div class="menu-block customscroll mCustomScrollbar _mCS_3"><div id="mCSB_3" class="mCustomScrollBox mCS-dark-2 mCSB_vertical mCSB_inside" tabindex="0" style="max-height: none;"><div id="mCSB_3_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr">
        <div class="sidebar-menu icon-style-1 icon-list-style-1">
            <ul id="accordion-menu">
                ...
                <li class="dropdown">
                 ...
                 <li class="dropdown">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/ad/blog">لیست بلاگ  </a></li>
                    </ul>
                ...
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle" data-option="off">
                        <span class="micon bi bi-table"></span><span class="mtext">کاربران</span>
                    </a>
                    <ul class="submenu">
                ...
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle" data-option="off">
                        <span class="micon bi bi-table"></span><span class="mtext">تنظیمات سایت </span>
                    </a>
                    <ul class="submenu"> <li><a href="/ad/slider">اسلایدر</a></li>
                    <li><a href="/ad/stati">قسمت سایت </a></li>
